...
{
  //Entrada
   Serial.println("Qual e seu nome?");//mostra a mensagem na tela
   while( !Serial.available() );//espera o usuario dar <Enter>
   nome = Serial.readStringUntil('\n');//transforma o nome em texto
  
   Serial.println("Digite o seu peso");//mostra a mensagem na tela
   while( !Serial.available() );//espera o usuario dar <Enter>
   peso = Serial.parseFloat(); 
  
   Serial.println("Digite a sua altura");//mostra a mensagem na tela
   while( !Serial.available() );//espera o usuario dar <Enter>
